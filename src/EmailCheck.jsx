      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content" style={{ borderRadius: '12px' }}>
            <div className="modal-header" style={{ backgroundColor: '#ccf5b0', borderBottom: 'none' }}>
              <h5 className="modal-title" id="codigoModalLabel">Verificación</h5>
              <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div className="modal-body text-center">
              <p>Introduce el código que te hemos enviado por correo electrónico:</p>
              <input type="text" className="form-control mb-3" placeholder="Código de verificación" />
